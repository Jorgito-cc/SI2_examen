    ...
    return Scaffold(
      ...
      bottomNavigationBar: NavigationBar(
        ...
        destinations: const [
          ...
          NavigationDestination(icon: Icon(Icons.event_available_outlined), label: 'Reservas'),
          NavigationDestination(icon: Icon(Icons.campaign_outlined), label: 'Avisos'),
          NavigationDestination(icon: Icon(Icons.notifications_outlined), label: 'Notifs'),
          NavigationDestination(icon: Icon(Icons.forum_outlined), label: 'Comunidad'), // <- NUEVA
        ],
      ),
    );
  }
