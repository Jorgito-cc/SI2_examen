...
import { BRAND, sections, soporteLink } from "./SidebarData"; // 👈 ruta según tu estructura
/* import { DarkToggle } from "../../products/ui/DarkToggle";     */ // 👈 ajusta la ruta si cambia
/* import { useAuth } from "../../../context/AuthContext";    */     // 👈 ajusta si tu contexto está en otra ruta

const cn = (...c) => c.filter(Boolean).join(" ");

export default function Sidebar() {
  const [isOpen, setIsOpen] = useState(true);
  const [openKey, setOpenKey] = useState("usuarios");
  const location = useLocation();
/*   const navigate = useNavigate();
  const { logout } = useAuth(); */

  // Abrir sección según ruta actual
  useEffect(() => {
